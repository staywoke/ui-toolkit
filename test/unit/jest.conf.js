...
module.exports = {
  ...
  collectCoverageFrom: [
    ...
    '!src/components/atoms/loading/*',
    '!src/components/atoms/menu-item/*',
    '!src/components/atoms/message/*',
    '!src/components/atoms/message-box/*',
    '!src/components/atoms/notification/*',
    '!src/components/atoms/option/*',
    '!src/components/atoms/popover/*',
    '!src/components/atoms/scrollbar/*',
    '!src/components/atoms/spinner/*',
    '!src/components/atoms/step/*',
    '!src/components/atoms/table-column/*',
